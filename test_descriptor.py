...
class SystemDescriptor(unittest.TestCase):
    ...
    #     current_path = os.path.realpath(__file__)
    #     head, tail = ntpath.split(current_path)
    #     os.system('SystemDescriptor.py -config ' + head + '\\Tests\\TRS.SYSDESC.FUNC.002_06\\ConfigSystemDescriptor.xml')
    ...
    #     current_path = os.path.realpath(__file__)
    #     head, tail = ntpath.split(current_path)
    #     os.system('SystemDescriptor.py -config ' + head + '\\Tests\\TRS.SYSDESC.FUNC.002_08\\ConfigSystemDescriptor.xml')
    ...
    #     current_path = os.path.realpath(__file__)
    #     head, tail = ntpath.split(current_path)
    #     os.system('SystemDescriptor.py -config ' + head + '\\Tests\TRS.SYSDESC.GEN.003_12\\ConfigSystemDescriptor.xml')
